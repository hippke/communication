...
for step in range(1, 40000):
    ...
    print(wavelength * 10**6, F, N, bits_per_photon, p, e, tot)
...
for i in range(1000):
    ax.add_patch(patches.Rectangle((0.35 + i/1000/3, 0), 0.01, 45,
        facecolor=cm(i/1000), edgecolor='none'))

ax.text(0.72, 10, r'IR')
ax.text(3.9, 500, r'$D_{\rm t}=1$\,m (space), $D_{\rm r}=10$\,m (space)', horizontalalignment='right')
ax.text(3.9, 450, r'$R=1.3$\,pc, $P=1000$\,W', horizontalalignment='right')
ax.text(3.9, 400, r'$\eta=0.5$, $M=10^5$', horizontalalignment='right')
