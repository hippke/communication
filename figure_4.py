...
ax.text(2 * 1E-6, 0.3, r'Diffraction limit', color='black')  # backgroundcolor='white')

# Observed limit
plt.plot((1E-6, 0.3), (3 * 1E-7, 1), color='black', linestyle='dotted')
ax.text(2 * 1E-6, 1E-3, 'Technological\nlimit 2017', color='black')  # backgroundcolor='white')
...
ax.text(0.007, 0.0006, r'Astrosat', color='blue')  # backgroundcolor='white')
...
frac = (0.10066464, 0.177643482, 0.2516616, 0.3355488, 0.431419886, 0.5033232, 0.575226514, 0.666163059, 0.740181176, 0.814199294, 0.888217412, 0.962235529, 1)
