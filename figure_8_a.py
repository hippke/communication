...
ax.text(3.9, 2700, r'$D_t=1$\,m (space), $D_r=39$\,m (Earth)', horizontalalignment='right')
ax.text(3.9, 2400, r'$R=1.3$\,pc, $P=1000$\,W', horizontalalignment='right')
ax.text(3.9, 2100, r'$\eta=0.5$, $M=10^5$', horizontalalignment='right')
